            ...
            if (editor.find("." + dialogName).length < 1)
            {
                ...
                fileInput.bind("change", function() {
                    ...
                    var submitHandler = function() {
                        ...
                        // var uploadIframe = document.getElementById(ditormd-image-iframe);
                        //
                        ...
                        //     return false;
                        // };
                        var form = $('.editormd-form')[0];
                        var formData = new FormData(form);
                        var file = document.getElementById('editormd-image-file').files[0];
                        //var file = $("#editormd-image-file").files;
                        var base64Codes;
                        var reader = new FileReader();
                        reader.readAsDataURL(file);
                        reader.onload = function (e) {
                            base64Codes = e.target.result;
                        ...
                        //formData.append('editormd-image-file', document.getElementById('editormd-image-file').files[0]);
