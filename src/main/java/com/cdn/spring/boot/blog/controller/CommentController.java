...
import com.cdn.spring.boot.blog.service.BlogService;
import com.cdn.spring.boot.blog.service.CommentService;
...
public class CommentController {
    ...
    public String listComments(@RequestParam(value="blogId",required=true) Long blogId, Model model) {
        ...
        List<Boolean> isCommentOwner = new ArrayList<>(comments.size());
        // 判断操作用户是否是评论的所有者
        String commentOwner = "";
    ...
    public ResponseEntity<Response> deleteBlog(@PathVariable("id") Long id, Long blogId) {
        ...
        return ResponseEntity.ok().body(new Response(true, "评论已删除", null));
    }
}
